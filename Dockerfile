...
RUN apt-get update \
  ...
  && wget --no-check-certificate -q -O rstudio-server-amd64.deb https://s3.amazonaws.com/rstudio-ide-build/server/debian9/x86_64/rstudio-server-1.3.929-amd64.deb \ 
